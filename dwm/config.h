...
static const int bhpad             = 12;        /* bar height padding (split between top and bottom) */

static const int vertpad           = 24;       /* vertical padding of bar */
static const int sidepad           = 24;       /* horizontal padding of bar */

static const char *fonts[]         = { "Victor Mono Nerd Font:size=12" };
static const char dmenufont[]      = "Victor Mono Nerd Font:size=12";
...
static const char *amdcmd[]      = { "android-messages-desktop", NULL };
static const char *discordcmd[]  = { "discord", NULL };
static const char *spootifycmd[] = { "st", "-e", "/home/caden/.scripts/spootify", NULL };
static const char *unicodecmd[]  = { "/home/caden/.scripts/unicode", NULL };
static const char *shotcmd[]     = { "flameshot", "gui", NULL };
static const char *leavecmd[]    = { "leave", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY|ShiftMask,             XK_d,      spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_Return, spawn,          {.v = termcmd } },
        { MODKEY,                       XK_n,      spawn,          {.v = lfcmd } },
        { MODKEY,                       XK_w,      spawn,          {.v = bravecmd } },
        { MODKEY,                       XK_a,      spawn,          {.v = amdcmd } },
        { MODKEY,                       XK_d,      spawn,          {.v = discordcmd } },
        { MODKEY,                       XK_s,      spawn,          {.v = spootifycmd } },
        { MODKEY,                       XK_u,      spawn,          {.v = unicodecmd } },
        { MODKEY,                       XK_p,      spawn,          {.v = shotcmd } },
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	{ MODKEY|ShiftMask,             XK_Escape,      spawn,          {.v = leavecmd } },
